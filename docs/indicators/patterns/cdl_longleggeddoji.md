# CDL_CDL_LONGLEGGEDDOJI (Long-Legged Doji)

## Overview

The Long-Legged Doji is a reversal/indecision candlestick pattern used in technical analysis to identify potential trading opportunities. The pattern consists of Doji with very long upper and lower shadows. This pattern provides traders with insights into market psychology and potential price movements when properly confirmed.
...
The Long-Legged Doji pattern measures:
- **Market Psychology**: Extreme volatility and indecision, market at crossroads
...
The Long-Legged Doji is identified by:
...
### Pattern Family
The Long-Legged Doji belongs to the candlestick pattern family used for:
...
Use Long-Legged Doji across multiple timeframes:
