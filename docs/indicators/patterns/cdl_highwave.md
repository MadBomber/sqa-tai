...
The High Wave Candle pattern measures:
- **Market Psychology**: Extreme indecision between bulls and bears, potential volatility
...
**Body Characteristics**: Very small body (open and close nearly equal)
**Shadow Characteristics**: Very long upper and lower shadows
...
The High Wave Candle is identified by:
...
High Wave Candle works best when:
...
### Pattern Family
The High Wave Candle belongs to the candlestick pattern family used for:
...
Use High Wave Candle across multiple timeframes:
