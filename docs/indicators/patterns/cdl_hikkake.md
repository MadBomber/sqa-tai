# CDL_CDL_HIKKAKE (Hikkake Pattern)
...
The Hikkake Pattern pattern measures:
- **Market Psychology**: False breakout trap - smart money trapping retail traders
...
Hikkake Pattern works best when:
...
### Pattern Family
The Hikkake Pattern belongs to the candlestick pattern family used for:
...
Use Hikkake Pattern across multiple timeframes:
