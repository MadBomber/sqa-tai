...
The Modified Hikkake Pattern pattern measures:
- **Market Psychology**: Enhanced version providing stronger reversal signal
...
- **Signal**: 100 or -100
- **Reliability**: Higher than standard Hikkake
...
Modified Hikkake Pattern works best when:
...
### Pattern Family
The Modified Hikkake Pattern belongs to the candlestick pattern family used for:
...
Use Modified Hikkake Pattern across multiple timeframes:
