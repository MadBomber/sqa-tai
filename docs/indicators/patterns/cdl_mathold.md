...
The Mat Hold pattern measures:
- **Market Psychology**: Brief consolidation in uptrend before continuation
...
- **Context**: Best used in uptrend
- **Signal**: 100
- **Reliability**: Moderate - rare pattern
...
Mat Hold works best when:
- Pattern appears in appropriate trend context (uptrend)
...
### Pattern Family
The Mat Hold belongs to the candlestick pattern family used for:
...
Use Mat Hold across multiple timeframes:
