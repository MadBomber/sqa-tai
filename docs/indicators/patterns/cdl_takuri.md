...
The Takuri Line (Dragonfly Doji at Support) pattern measures:
- **Market Psychology**: Strong rejection of lower prices, bulls gaining control
...
- **Signal**: 100
- **Reliability**: High - especially at key support
...
The Takuri Line (Dragonfly Doji at Support) is identified by:
...
Takuri Line (Dragonfly Doji at Support) works best when:
...
### Pattern Family
The Takuri Line (Dragonfly Doji at Support) belongs to the candlestick pattern family used for:
...
Use Takuri Line (Dragonfly Doji at Support) across multiple timeframes:
