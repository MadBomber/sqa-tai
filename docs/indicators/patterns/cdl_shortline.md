...
The Short Line Candle pattern measures specific price action characteristics that suggest potential market direction. Candlestick patterns capture market psychology through the interaction of opening, high, low, and closing prices within and across multiple periods.
...
- **Type**: single-candle candlestick pattern
...
- **+100 (bullish) or -100 (bearish)**: Pattern detected - indicates potential strength signal
