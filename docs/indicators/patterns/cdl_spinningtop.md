...
The Spinning Top pattern measures:
- **Market Psychology**: Indecision, balance between buyers and sellers
...
The Spinning Top is identified by:
...
### Pattern Family
The Spinning Top belongs to the candlestick pattern family used for:
...
Use Spinning Top across multiple timeframes:
