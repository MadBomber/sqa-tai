...
The Ladder Bottom pattern measures:
- **Market Psychology**: Extreme selling exhaustion followed by buying pressure
...
The Ladder Bottom is identified by:
...
### Pattern Family
The Ladder Bottom belongs to the candlestick pattern family used for:
...
Use Ladder Bottom across multiple timeframes:
