# CDL_CDL_HOMINGPIGEON (Homing Pigeon)
...
The Homing Pigeon pattern measures:
- **Market Psychology**: Selling pressure decreasing, potential bottom formation
...
The Homing Pigeon is identified by:
...
### Pattern Family
The Homing Pigeon belongs to the candlestick pattern family used for:
...
Use Homing Pigeon across multiple timeframes:
